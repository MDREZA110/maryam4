...
class ParvarishSection extends StatefulWidget {
  final List cardItems;
  const ParvarishSection({super.key, required this.cardItems});

  @override
  State<ParvarishSection> createState() => ParvarishSectionState();
}

class ParvarishSectionState extends State<ParvarishSection> {
  int count = 0;
  @override
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...widget.cardItems
                    .where((item) => item['MenuId'].toString() == '4')
                    .map((item) // =>
                        {
                  if (count < 1) {
                    count++;
