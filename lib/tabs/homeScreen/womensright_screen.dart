...
class WomensRightSection extends StatefulWidget {
  final List cardItems;
  const WomensRightSection({super.key, required this.cardItems});

  @override
  State<WomensRightSection> createState() => _WomensRightSectionState();
}

class _WomensRightSectionState extends State<WomensRightSection> {
  int count = 0;
  @override
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...widget.cardItems
                    .where((item) => item['MenuId'].toString() == '2')
                    .map((item) // =>
                        {
                  if (count < 1) {
                    count++;
